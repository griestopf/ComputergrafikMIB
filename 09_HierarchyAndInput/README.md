...
- Fügt eine Möglichkeit ein, dass Benutzer die Kamera mit der Maus um das Geschehen drehen können ()
  - Bei gedrückter linker  Maustaste (
    ...
    als Eingabe einer Änderungsrate für '_camAngle' verwendet werden.
...
- Fügt eine Greifhand (aus zwei oder drei weiteren Quandern) in die Hierarchie ein und erzugt
  Interaktion zum Öffnen und Schließen der Hand.
