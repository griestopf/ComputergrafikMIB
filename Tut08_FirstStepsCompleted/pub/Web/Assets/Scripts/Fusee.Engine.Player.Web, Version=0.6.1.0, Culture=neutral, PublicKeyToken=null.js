...
'use strict';
var $asm07 = JSIL.DeclareAssembly("Fusee.Engine.Player.Web, Version=0.6.1.0, Culture=neutral, PublicKeyToken=null");

JSIL.SetEntryPoint($asm07, $asm07.TypeRef("Fusee.Engine.Player.Web.Simple"), "Main", JSIL.MethodSignature.Void);
...
(function Simple$Members () {
  ...
  var $T07 = function () {
    return ($T07 = JSIL.Memoize($asm07.Fusee.Engine.Player.Web.Simple_$l$gc)) ();
  };
  var $T08 = function () {
    return ($T08 = JSIL.Memoize($asm0A.Fusee.Serialization.SceneContainer)) ();
  };
  var $T09 = function () {
    return ($T09 = JSIL.Memoize($asm01.Fusee.Base.Core.AssetStorage)) ();
  };
  var $T0A = function () {
    return ($T0A = JSIL.Memoize($asm24.Fusee.Tutorial.Core.FirstSteps)) ();
  };
  var $T0B = function () {
  ...
  var $S00 = function () {
    return ($S00 = JSIL.Memoize(new JSIL.MethodSignature($asm0E.System.Object, [$asm0E.System.String, $asm0E.System.Object]))) ();
  };
  var $S01 = function () {
    return ($S01 = JSIL.Memoize(new JSIL.MethodSignature($asm0E.System.Boolean, [$asm0E.System.String]))) ();
  };
  var $S02 = function () {
    return ($S02 = JSIL.Memoize(new JSIL.MethodSignature($asm0E.System.Object, [$asm0E.System.String, $asm0E.System.Object]))) ();
  };
  var $S03 = function () {
    return ($S03 = JSIL.Memoize(new JSIL.MethodSignature($asm0E.System.Boolean, [$asm0E.System.String]))) ();
  };
  ...
  function Simple_Main () {
    ...
    if ((arg_4D_1 = $T07().$l$g9__0_0) === null) {
      arg_4D_1 = $T07().$l$g9__0_0 = $T00().New($T07().$l$g9, null, new JSIL.MethodPointerInfo($asm07.Fusee.Engine.Player.Web.Simple_$l$gc, "$lMain$gb__0_0", $S00(), false, false));
    }
    handler.Decoder = arg_4D_1;
    if ((arg_73_1 = $T07().$l$g9__0_1) === null) {
      arg_73_1 = $T07().$l$g9__0_1 = $T01().New($T07().$l$g9, null, new JSIL.MethodPointerInfo($asm07.Fusee.Engine.Player.Web.Simple_$l$gc, "$lMain$gb__0_1", $S01(), false, false));
    }
    ...
    if ((arg_BA_1 = $T07().$l$g9__0_2) === null) {
      arg_BA_1 = $T07().$l$g9__0_2 = $T00().New($T07().$l$g9, null, new JSIL.MethodPointerInfo($asm07.Fusee.Engine.Player.Web.Simple_$l$gc, "$lMain$gb__0_2", $S02(), false, false));
    }
    handler.Decoder = arg_BA_1;
    if ((arg_E0_1 = $T07().$l$g9__0_3) === null) {
      arg_E0_1 = $T07().$l$g9__0_3 = $T01().New($T07().$l$g9, null, new JSIL.MethodPointerInfo($asm07.Fusee.Engine.Player.Web.Simple_$l$gc, "$lMain$gb__0_3", $S03(), false, false));
    }
...
(function $l$gc$Members () {
  ...
  var $T06 = function () {
    return ($T06 = JSIL.Memoize($asm0B.Fusee.Serialization.Serializer)) ();
  };
  var $T07 = function () {
    return ($T07 = JSIL.Memoize($asm0A.Fusee.Serialization.SceneContainer)) ();
  };
  var $T08 = function () {
    return ($T08 = JSIL.Memoize($asm10.ProtoBuf.Meta.TypeModel)) ();
  };
  var $T09 = function () {
  ...
  var $S00 = function () {
    return ($S00 = JSIL.Memoize(new JSIL.MethodSignature($asm0E.System.Object, [
  ...
  function $l$gc_$lMain$gb__0_2 (id, storage) {
    ...
    if (flag) {
      var ser = new ($T06())();
      var result = $T07().$As($S00().CallVirtual("Deserialize", null, ser, $T09().StreamFromFile(JSIL.ConcatString("Assets/", id), $T0A().Open), null, $T07().__Type__));
    } else {
      result = null;
    }
    return result;
